    ...
    <div className="bg-white text-black min-h-screen">
      ...
      <Fade>
        <div className="text-4xl font-normal text-left mt-24 ml-40 mb-20">
          <p>Hi, I’m a software engineer and a</p>
          <p>content creator posting regularly about</p>
      ...
      <div className="grid grid-cols-2 gap-2 mt-10 ml-2">
        ...
        <Fade>
          <div className="text-4xl font-normal text-left mt-24 ml-40 mb-20">
            ...
            <p>content creator </p>
            <button className="bg-transparent mt-5 text-sm hover:underline">View Projects</button>
          </div>
        </Fade>
      </div>
      <Fade>
