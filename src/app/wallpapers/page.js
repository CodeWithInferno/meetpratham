      ...
      <Fade>
        ...
        <div className="flex flex-row items-center justify-center bg-white rounded-lg p-4 mb-4">
          <div className="flex flex-col mr-4">
            ...
            <button className="bg-transparent text-black font-bold py-2 px-4 rounded border  border-black float-right">
              Button
            </button>
          </div>
        ...
        <div className="flex flex-row-reverse items-center justify-center bg-white rounded-lg p-4 mb-4">
          <div className="flex flex-col ml-4">
            ...
            <button className="bg-transparent text-black font-bold py-2 px-4 rounded border  border-black float-left">
              Button
            </button>
          </div>
          <Image
